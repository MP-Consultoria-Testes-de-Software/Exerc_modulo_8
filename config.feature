...
Quando eu digitar a quantidade que quero comprar (maior que o estoque)
Então deve verificar o total do estoque
E exibir uma mensagem "Quantidade indisponível"
E preencher o campo quantidade com valor mínimo disponível

Cenário: Configurar quantidade do produto dentro do estoque
Quando eu digitar a quantidade que quero comprar (dentro do estoque)
